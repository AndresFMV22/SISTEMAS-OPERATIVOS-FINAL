...
El plan previo de exploración del dominio está en el documento
"plan_preguntas_etapa5.md" que acompaña esta entrega. De las diez preguntas
más recurrentes de una cadena de frío, las tres menos exploradas resultaron
ser la duración de las desviaciones, su agrupación en rachas y la
identificación del inventario concreto que estuvo en riesgo. Esta pregunta
las reúne.

La pregunta habitual del dominio es "¿cuántas lecturas salieron de rango?",
que se responde con un count y un group by. Esa respuesta no distingue entre
veinte picos aislados y una racha sostenida de veinte lecturas: operativamente
son problemas distintos -el primero sugiere ruido del sensor, el segundo una
falla del equipo de refrigeración- y el conteo plano los confunde.
